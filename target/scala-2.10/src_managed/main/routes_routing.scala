// @SOURCE:/home/jimmy/git/playframework/samples/java/zentasks/conf/routes
// @HASH:b6deab7e514d7ba67a1b83f6f6b3554f934549bf
// @DATE:Thu Jan 30 09:03:43 CST 2014
...
// @LINE:39
private[this] lazy val controllers_Photos_index19 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("photos"))))
        

// @LINE:40
private[this] lazy val controllers_Photos_index20 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("photos/"))))
        

// @LINE:41
private[this] lazy val controllers_Photos_add21 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("photos/"))))
        

// @LINE:42
private[this] lazy val controllers_Photos_update22 = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("photos/"),DynamicPart("photo", """[^/]+""",true))))
...
// @LINE:39
case controllers_Photos_index19(params) => {
   call { 
        invokeHandler(controllers.Photos.index(), HandlerDef(this, "controllers.Photos", "index", Nil,"GET", """ Photo""", Routes.prefix + """photos"""))
   }
}
        

// @LINE:40
case controllers_Photos_index20(params) => {
   call { 
        invokeHandler(controllers.Photos.index(), HandlerDef(this, "controllers.Photos", "index", Nil,"GET", """""", Routes.prefix + """photos/"""))
   }
}
        

// @LINE:41
case controllers_Photos_add21(params) => {
   call { 
        invokeHandler(controllers.Photos.add(), HandlerDef(this, "controllers.Photos", "add", Nil,"POST", """""", Routes.prefix + """photos/"""))
   }
}
        

// @LINE:42
case controllers_Photos_update22(params) => {
   call(params.fromPath[Long]("photo", None)) { (photo) =>
        invokeHandler(controllers.Photos.update(photo), HandlerDef(this, "controllers.Photos", "update", Seq(classOf[Long]),"PUT", """""", Routes.prefix + """photos/$photo<[^/]+>"""))
   }
}
