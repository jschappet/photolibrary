    ...
    public static Result javascriptRoutes() {
        ...
        return ok(
            Routes.javascriptRouter("jsRoutes",
                ...
                // Routes for Photos
                //controllers.routes.javascript.Photos.addFolder(),
                //controllers.routes.javascript.Photos.renameFolder(),
                //controllers.routes.javascript.Photos.deleteFolder(),
                controllers.routes.javascript.Photos.index(),
                controllers.routes.javascript.Photos.add(),
                controllers.routes.javascript.Photos.update()
                //controllers.routes.javascript.Photos.delete()
